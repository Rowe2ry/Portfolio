        ...
        <article className="row">
                <section className="card">
                    ...
                    <div className="card__body row">
                        <div className="photo">
                            <a  target="_blank" href="https://overdrive-automotive-school.herokuapp.com/" rel="noreferrer"><img src={odScreenshot} alt="Web application to teach people how to work on cars."/></a>
                        </div>
