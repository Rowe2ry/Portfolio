            ...
            <div className="container">
                ...
                <div className="row">
                    <article className="card">
                        ...
                        <section className="card__body row">
                            <div className="card__text">
                                <p><strong>Values:</strong> I'm a {new Date().getFullYear() - 1990} year old living in Atlanta, GA. My pronouns are "Him/He" and currently have 1 son. My wife, Merry and I are proudly Christian with an emphasis on loving everybody and being accepting. We care about family, community, and creating environments where people are constantly able to grow. We have 2 cats and we host international language sutdents out of our home.</p>
                            </div>
                            <div className="card__text">
